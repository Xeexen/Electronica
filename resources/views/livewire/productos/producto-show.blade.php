                        ...
                        <div class="inline-block min-w-full align-middle">
                            <div class="relative overflow-hidden">
                                ...
                                >
                                    <div
                                        wire:loading.flex
                                        class="items-center justify-center w-screen h-full sm:w-auto"
                                    >
                                    ...
                                    <tbody class="divide-y divide-slate-200 dark:divide-slate-200/10">
                                        @forelse($productos as $product)
                                            ...
                                            >
                                                ...
                                                <td class="relative px-3 py-4 text-sm font-medium text-left text-slate-900 whitespace-nowrap dark:text-slate-200">
                                                ...
                                                <td class="relative px-3 py-4 text-sm text-center text-slate-500 whitespace-nowrap dark:text-slate-400">
                                        ...
                                        @empty
                                            <tr>
                                                <td
                                                    class="px-3 py-4 text-sm text-center text-slate-500 whitespace-nowrap dark:text-slate-400"
                                                    colspan="4"
                                                >
                                                    <div class="max-w-lg mx-auto text-center">
