...
use App\Http\Livewire\Productos\ProductoShow;
use App\Http\Livewire\Productos\ProductoCreate;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/productos', ProductoShow::class)->name('productos-list');
    Route::get('/products/{product:id}', \App\Http\Livewire\Employee\Product\ProductDetail::class)->name('producto-edit');
    Route::get('/producto/crear', ProductoCreate::class)->name('producto-crear');
